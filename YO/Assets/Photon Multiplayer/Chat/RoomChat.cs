...
namespace Chat
{
	...
	public class RoomChat : MonoBehaviourPunCallbacks, IPointerDownHandler
	{
		...
		private string FormatName(Player player)
		{
			...
			var localColor = Color.green;//ColorUtility.ToHtmlStringRGB(new Color(0.9f, 0.8f, 0.7f));
			var otherColor = Color.black;//ColorUtility.ToHtmlStringRGB(new Color(0.2f, 0.8f, 1f));
